...
| **Fabric API** | Any version for 1.21.4 | [Modrinth](https://modrinth.com/mod/fabric-api) |
| **Architectury API** | 15.0.x | [Modrinth](https://modrinth.com/mod/architectury-api) |
...
3. Download `vouch-fabric-0.1.0+1.21.4.jar` and place it in your `mods/` folder.
4. Start the server.

```
server/
├── mods/
│   ├── fabric-api-x.x.x+1.21.4.jar
│   ├── architectury-15.0.x-fabric.jar
│   └── vouch-fabric-0.1.0+1.21.4.jar
├── server.jar
└── ...
```
...
| Mod | Required | Link |
|-----|----------|------|
| **NeoForge** | ≥ 21.4 | [neoforged.net](https://neoforged.net/) |
| **Architectury API** | 15.0.x | [Modrinth](https://modrinth.com/mod/architectury-api) |
...
3. Download `vouch-neoforge-0.1.0+1.21.4.jar` and place it in your `mods/` folder.
4. Start the server.

```
server/
├── mods/
│   ├── architectury-15.0.x-neoforge.jar
│   └── vouch-neoforge-0.1.0+1.21.4.jar
├── server.jar
└── ...
```
